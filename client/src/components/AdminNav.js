...
const AdminNav = ({openSidebar}) => {
    ...
    return(
        <nav className="fixed left-0 sm:left-64 top-4 right-0 mx-4">
            <div className="bg-gray-800 w-full flex p-5 justify-between sm:justify-end items-center">
            <i className="bi bi-filter-left text-white text-2xl cursor sm:hidden block" onClick={openSidebar}></i>
